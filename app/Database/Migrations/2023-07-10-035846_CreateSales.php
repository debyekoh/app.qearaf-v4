...
class CreateSales extends Migration
{
    ...
    {
        $this->forge->addField([
            'id_sales'          => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
            'no_sales'          => ['type' => 'varchar', 'constraint' => 20, 'null' => false],
        ...
        $this->forge->addField([
            'id_sales_detail'   => ['type' => 'varchar', 'constraint' => 20, 'null' => false],
            'no_sales'          => ['type' => 'varchar', 'constraint' => 20, 'null' => false],
