                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="mb-4 pb-2">
                            <a class="d-block auth-logo">
                                <img src="ad_assets/dist/assets/images/Logo Admin Dark 40px.webp" alt="" height="40" class="auth-logo-dark me-start">
                                <!-- <img src="ad_assets/dist/assets/images/Logo Light Dark 40px.webp" alt="" height="40" class="auth-logo-light me-start"> -->
                            </a>
                        </div>
                            ...
                            <div class="card-body p-4"> 
                                <div class="p-2 my-2 text-center">
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <p class="text-muted font-size-15">Thank you for visiting <span class="fw-semibold text-dark">Qearaf.Com</span></p>
                                        <div class="mt-4">
                                            <a href="<?=base_url()?>signin" class="btn btn-primary w-100 waves-effect waves-light">Sign In</a>
                                        </div>
                                    </div>
                                </div>
