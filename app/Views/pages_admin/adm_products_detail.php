                    ...
                    <div class="row">
                                                ...
                                                <div class="swiper-slide rounded">
                                                    <div class="p-3">
                                                        <div class="product-img bg-light rounded p-3">
                                                            <img src="<?= base_url() ?>assets/images/product/<?= $img['pro_image_name']; ?>" style="aspect-ratio: 1/1;" class="img-fluid d-block" />
                                                        </div>
                                                    </div>
                                                </div>
                                        <?php }
                                            ...
                                            <?php if ($DataImage != null) {
                                                foreach ($DataImage as $img) { ?>
                                                    <div class="swiper-slide">
                                                        <div class="nav-slide-item"><img src="<?= base_url() ?>assets/images/product/<?= $img['pro_image_name']; ?>" style="aspect-ratio: 1/1;" class="img-fluid p-1 d-block rounded" /></div>
                                                    </div>
                                            <?php }
                                            } ?>
                                        </div>
                        ...
                        <div class="col-xl-8">
                            <div class="mt-3 mt-xl-3 ps-xl-5">
                                <h4 class="font-size-20 mb-1"><a href="" class="text-dark"><?= $DataProduct['pro_name'] ?> - <?= $DataProduct['pro_model'] ?></a></h4>
                                ...
                                <h2 class="text-primary mt-4 py-2 mb-0"><?= "Rp " . number_format($DataPrice['pro_price_reseler'], 2); ?> <del class="text-muted font-size-18 fw-medium ps-1"><?= number_format($DataPrice['pro_price_seller'], 2); ?></del>
                                    <!-- <span class="badge bg-danger font-size-10 ms-1">20 % Off</span> -->
                                    <span class="badge bg-danger font-size-10 ms-1"><?= number_format(((($DataPrice['pro_price_seller'] - $DataPrice['pro_price_reseler']) / $DataPrice['pro_price_reseler']) * 100), 0); ?> % Off For Reseller</span>
                                </h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mt-3">
                                                ...
                                                <ul class="list-unstyled ps-0 mb-0 mt-3">
                                                    <li>
                                                        <p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle text-primary me-1"></i> Full heighted Hydraulic</p>
                                                    </li>
                                                    <li>
                                                        <p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle text-primary me-1"></i> Heavy Dencity Premium Cushion</p>
                                                    </li>
                                                    <li>
                                                        <p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle text-primary me-1"></i> Colour According To Salon Interior</p>
                                                    </li>
                                                    <li>
                                                        <p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle text-primary me-1"></i> 1 Year Gurantee On All Parts</p>
                                                    </li>
                                                    <li>
                                                        <p class="text-muted mb-0 text-truncate"><i class="mdi mdi-circle-medium align-middle text-primary me-1"></i> Size 25inch x 25inch</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mt-3">
                                                ...
                                                <ul class="list-unstyled ps-0 mb-0 mt-3">
                                                    <li>
                                                        <p class="text-muted mb-1 text-truncate"><i class="mdi mdi-circle-medium align-middle text-primary me-1"></i> 10 Days Replacement </p>
                                                    </li>
                                                    <li>
                                                        <p class="text-muted mb-0 text-truncate"><i class="mdi mdi-circle-medium align-middle text-primary me-1"></i> Cash on Delivery available </p>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="mt-3">
                                    ...
                                    <div class="px-4" data-simplebar style="max-height: 360px;">
                                        <div class="border-bottom pb-3">
                                            ...
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex">
                                                        <img src="<?= base_url() ?>assets/images/users/avatar-2.jpg" class="avatar-sm rounded-circle" alt="">
                                        ...
                                        <div class="border-bottom py-3">
                                            ...
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex">
                                                        <img src="<?= base_url() ?>assets/images/users/avatar-3.jpg" class="avatar-sm rounded-circle" alt="">
                                                        <div class="flex-1 ms-2 ps-1">
                                        ...
                                        <div class="pt-3">
                                            ...
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex">
                                                        <img src="<?= base_url() ?>assets/images/users/avatar-6.jpg" class="avatar-sm rounded-circle" alt="">
                                                        <div class="flex-1 ms-2 ps-1">
                                    ...
                                    <div class="tab-pane fade" id="desc" role="tabpanel">
                                        <div class="row">
                                            <div class="col-sm-3 col-md-3">
                                                <div>
                                                    <img src="<?= base_url() ?>assets/images/product/img.png" alt="" class="img-fluid mx-auto rounded d-block">
                                                </div>
                                            </div>
...
<!-- <script src="<?= base_url() ?>https://code.jquery.com/jquery-1.12.4.js" integrity="sha256-Qw82+bXyGq6MydymqBxNPYTaUXXq7c8v3CwiYwLLNXU=" crossorigin="anonymous"></script> -->
