                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            <div class="p-3 border-bottom">
                                <h6 class="mb-0">TESTPage</h6>
                                <p class="mb-0 font-size-11 text-muted">TESTPage</p>
                            </div>
                            <a class="dropdown-item" href="profile"><i class="mdi mdi-account-circle text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Profile</span></a>
                            ...
                            <a class="dropdown-item" href="go_logout"><i class="mdi mdi-logout text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Logout</span></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="<?= base_url() ?>tokopediaqea" data-key="t-tokopedia-qea">Tokopedia QEA</a></li>
                                <li><a href="<?= base_url() ?>shopeeqea" data-key="t-shopee-qea">Shopee QEA</a></li>
                                <li><a href="<?= base_url() ?>shopeerf" data-key="t-shopee-rf">Shopee RF.OTO</a></li>
                                <li><a href="javascript: void(0);" class="has-arrow" data-key="t-reseller">Reseller</a>
                                    <ul class="sub-menu" aria-expanded="true">
                                        <li><a href="<?= base_url() ?>resellerhafidz" data-key="t-reseller-hafidz">Reseller Hafidz</a></li>
                                        <li><a href="<?= base_url() ?>resellersafar" data-key="t-reseller-safar">Reseller Safar</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                        <a href="<?= base_url() ?>dashboards" class="dropdown-item" data-key="t-ecommerce">Ecommerce</a>
