...
function showTab(e) {
    ...
    document.getElementById("cancelBtn").style.display = 0 == e ? "block" : "none",
    document.getElementById("nextBtn").style.display = t.length - 1 == e ? "none" : "inline",
    document.getElementById("submitBtn").style.display = t.length - 1 == e ? "block" : "none",
...
function fixStepIndicator(e) {
    for (var t = document.getElementsByClassName("list-item"), n = 0; n < t.length; n++)
