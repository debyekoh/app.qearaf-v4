                                            ...
                                            '<span>'+
                                                '<div class="dropdown">'+
                                                    ...
                                                    '<ul class="dropdown-menu dropdown-menu-end" style="">'+
                                                        '<li><a href="javascript: void(0);" onclick="addProduct()" role="button" class="dropdown-item fw-bold"><i class="mdi mdi-arrow-expand-all font-size-16 me-1"></i> View</a></li>'+
                                                        '<li><a href="javascript: void(0);" onclick="addProduct()" role="button" class="dropdown-item fw-bold"><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Cancel</a></li>'+
